...
## 13. Reading The Public ClinVar/HPO Subset

The project also includes a small public-data subset:

data/public/

This directory is generated by:

scripts/build_public_clinvar_dataset.py

The builder streams the public ClinVar GRCh38 VCF and public HPO
genes_to_phenotype file, selects a small set of variants and phenotype
annotations for SCN1A, CFTR, FBN1, and TSC2, and writes them into the same file
shape used by the rest of the project.
...
## 14. Why TSC2 Ranked First In The Example
...
## 15. Where Machine Learning Fits
...
## 16. What Would Make This More Real
...
data/public/: Small public ClinVar/HPO-derived dataset.
